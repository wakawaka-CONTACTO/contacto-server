...
public interface UserLikeRepository extends JpaRepository<UserLike, Long> {
    ...
    @Query("SELECT ul.userId FROM UserLike ul WHERE ul.likedUserId = :likedUserId GROUP BY ul.userId ORDER BY COUNT(ul.likedUserId) DESC")
    List<Long> findAllByLikedUserId(@Param("likedUserId") Long likedUserId);
